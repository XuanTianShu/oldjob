...
//		httpGetExample();
	...
	public static void httpGetExample() throws Exception {
		...
		String version = "20220924042921";// api版本，到文档中心->使能平台API文档打开要调用的api可以找到此值
		...
		uriBuilder.setHost("2000297260.api.ctwing.cn/aep_product_management");//请求地址
...
//		uriBuilder.addParameter("productId", "16668951");
	...
	public static void httpPostExample() throws Exception {
		...
		String bodyString = "{\"content\": {\"jtMessageId\":\"0x0102\",\"jtMessageType\":\"0x00\"," +
				"\"dataType\":1,\"payload\":\"112233\"},\"deviceId\":\"29f6270786434bfe877ccc383a8d973d\"," +
				"\"operator\":\"string\",\"productId\":16668951,\"ttl\":7200,\"deviceGroupId\": 100,\"level\": 1}";
		CloseableHttpClient httpClient = null;
		HttpResponse response = null;
		httpClient = HttpClientBuilder.create().build();
		long offset = getTimeOffset();// 获取时间偏移量，方法见前面
