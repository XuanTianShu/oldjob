...
public class MyDepositServiceImpl implements MyDepositService {
     ...
     */
    @Override
    public List<UserDepositOrder> selectUserDepositInfo(String openid, String status,String depositStatus) {
        return userDepositOrderMapper.selectUserDepositInfo(openid,status,depositStatus);
    }
