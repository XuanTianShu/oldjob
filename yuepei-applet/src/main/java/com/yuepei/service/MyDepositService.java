 ...
 *
 * @author ：AK
 * @create ：2022/12/8 16:07
 **/
@Service
public interface MyDepositService {

    List<UserDepositOrder> selectUserDepositInfo(String openid, String status,String depositStatus);

    List<UserIntegralBalanceDepositVo>selectUserDepositDetailInfo(String openid, Integer status);
}
