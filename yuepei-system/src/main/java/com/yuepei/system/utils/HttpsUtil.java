...
public class HttpsUtil {
	...
	public void initSSLConfigForTwoWay() throws Exception {
		...
		SSLConnectionSocketFactory sslsf = new SSLConnectionSocketFactory(
				sc, new com.yuepei.system.utils.DefaultHostnameVerifier());
	...
	public HttpResponse doPostJson(String url, Map<String, String> headerMap,
	   ...
	   public com.yuepei.system.utils.StreamClosedHttpResponse doPostMultipartFile(String url, Map<String, String> headerMap,
                                                                     File file) {
	        HttpPost request = new HttpPost(url);
	        addRequestHeader(request, headerMap);
	        ...
	        return (com.yuepei.system.utils.StreamClosedHttpResponse) executeHttpRequest(request);
	    }

	public com.yuepei.system.utils.StreamClosedHttpResponse doPostJsonGetStatusLine(
		...
		return (com.yuepei.system.utils.StreamClosedHttpResponse) response;
	}

	public com.yuepei.system.utils.StreamClosedHttpResponse doPostJsonGetStatusLine(String url, String content) {
		HttpPost request = new HttpPost(url);
	...
	public com.yuepei.system.utils.StreamClosedHttpResponse doPostFormUrlEncodedGetStatusLine(
	...
	public com.yuepei.system.utils.StreamClosedHttpResponse doPutJsonGetStatusLine(String url, Map<String, String> headerMap,
                                                                     String content) {
	...
	public com.yuepei.system.utils.StreamClosedHttpResponse doPutGetStatusLine(String url, Map<String, String> headerMap) {
	...
	public com.yuepei.system.utils.StreamClosedHttpResponse doGetWithParasGetStatusLine(String url,
                                                                          Map<String, String> queryParams, Map<String, String> headerMap)
			throws Exception {
	...
	public com.yuepei.system.utils.StreamClosedHttpResponse doDeleteWithParasGetStatusLine(String url,
                                                                             Map<String, String> queryParams, Map<String, String> headerMap)
			throws Exception {
	...
	private HttpResponse executeHttpRequest(HttpUriRequest request) {
		...
		try {
			...
			try {
				response = new com.yuepei.system.utils.StreamClosedHttpResponse(response);
			} catch (IOException e) {
	...
	public String getHttpResponseBody(HttpResponse response)
		...
		if (response instanceof com.yuepei.system.utils.StreamClosedHttpResponse) {
			body = ((com.yuepei.system.utils.StreamClosedHttpResponse) response).getContent();
		} else {
