...
public class Constant {
    ...
    //修改以下两个参数，由电信平台提供.
    public static final String APPID = "ad1ddd68e3f941b78389ba11584917f9";
    public static final String SECRET = "1c227a6b2d964c11985197521995c510";
    /*
     *IP and port of callback url.
     *请将这个url改成你的云服务器网址
     */
    public static final String CALLBACK_BASE_URL = "https://www.yp10000.com/prod-api";
     ...
     * please replace uri, when you use the demo.
     */
    public static final String REPORT_CMD_EXEC_RESULT_CALLBACK_URL = CALLBACK_BASE_URL + "/wechat/user/refund/unlocking";


    //Paths of certificates.
    public static String SELFCERTPATH = "/src/cert/outgoing.CertwithKey.pkcs12";
    public static String TRUSTCAPATH = "/src/cert/ca.jks";
