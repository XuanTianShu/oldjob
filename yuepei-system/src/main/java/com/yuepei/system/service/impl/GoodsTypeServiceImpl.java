...
public class GoodsTypeServiceImpl implements GoodsTypeService {
     ...
     */
    @Override
    public boolean checkGoodsType(GoodsType goodsType) {
        int i = goodsTypeMapper.checkGoodsType(goodsType);
        if (i > 0){
            return true;
        }
        return false;
     ...
     */
    @Override
    public boolean checkGoodsTypeByIds(Long[] goodsTypeIds) {
        int i = goodsTypeMapper.checkGoodsTypeByIds(goodsTypeIds);
        if (i > 0){
            return true;
        }
        return false;
