...
public class DeviceServiceImpl implements DeviceService {
     ...
     */
    @Override
    public Device selectDeviceInfoByDeviceNumber(String deviceNumber) {
        Device device = deviceMapper.selectDeviceByDeviceNumber(deviceNumber);
        List<DeviceRule> deviceRules = deviceMapper.selectDeviceInfoByDeviceNumber(device.getDeviceTypeId());
